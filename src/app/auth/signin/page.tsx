...
export default function SignInPage() {
  const hasProviders = hasGitHub || hasGoogle
          ...
          {!hasProviders ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-slate-500">
                To enable authentication, add GITHUB_ID, GITHUB_SECRET (and optionally GOOGLE_ID, GOOGLE_SECRET) to your .env file.
              </p>
              ...
              {hasGitHub && (
                ...
                >
                  <Button 
                    type="submit" 
                    variant="outline" 
                    className="w-full h-12 text-base border-slate-600 hover:bg-slate-700 hover:text-slate-100"
                  >
