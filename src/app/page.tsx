  ...
  if (sort === 'trending') {
    ...
    return {
      servers: paginated.map((serverWithRatings: ServerWithRecentRatings) => ({
        ...
        version: serverWithRatings.version,
        repositoryUrl: serverWithRatings.repositoryUrl,
        packages: serverWithRatings.packages,
        remotes: serverWithRatings.remotes,
        ...
        syncedAt: serverWithRatings.syncedAt,
      })),
      total,
      page,
      totalPages: Math.ceil(total / limit),
