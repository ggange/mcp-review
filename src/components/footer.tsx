      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="space-y-3">
            <Link href="/" className="text-lg font-semibold text-foreground hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
              MCP Review
            </Link>
            <p className="text-sm text-muted-foreground leading-relaxed">
              The open-source directory for <abbr title="Model Context Protocol">MCP</abbr> servers. 
              Community-driven ratings and reviews for AI developers.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <nav className="flex flex-col gap-2" aria-label="Community links">
              <a 
          ...
          <div className="space-y-3">
            ...
            <nav className="flex flex-col gap-2" aria-label="Resources links">
              ...
              <a
                href="https://www.iubenda.com/privacy-policy/27793305"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-muted-foreground hover:text-foreground transition-colors"
              >
              ...
              <a
                href="https://www.iubenda.com/privacy-policy/27793305/cookie-policy"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-muted-foreground hover:text-foreground transition-colors"
              >
